...
import bpmn_python_lib2.bpmn_diagram_visualizer as visualizer
import bpmn_python_lib2.bpmn_diagram_rep as diagram


class BPMNEditorTests(unittest.TestCase):
    """
    This class contains test for bpmn_python_lib2 package functionality using an example BPMN diagram created in BPMNEditor.
    """
