...
[task1_id, _] = bpmn_graph.add_task_to_diagram(process_id, pos_x=200, pos_y=500, task_name="task1")
# bpmn_graph.add_sequence_flow_to_diagram(process_id, start_id, task1_id, "start_to_one")

[task2_id, _] = bpmn_graph.add_task_to_diagram(process_id, pos_x=1000, pos_y=600, task_name="task2")
