...
# import bpmn_python_lib2.bpmn_python_consts as consts
# import bpmn_python_lib2.grid_cell_class as cell_class

import bpmn_python_lib2.bpmn_python.bpmn_python_consts as consts
import bpmn_python_lib2.bpmn_python.grid_cell_class as cell_class
...
def set_coordinates_for_nodes(bpmn_graph, grid):
    ...
    for node in nodes:
        ...
        node[1][consts.Consts.x] = str(cell.col * 100 + 50)
