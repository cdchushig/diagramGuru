...
import bpmn_python_lib2.bpmn_python.bpmn_diagram_exception as bpmn_exception
import bpmn_python_lib2.bpmn_python.bpmn_diagram_export as bpmn_export
import bpmn_python_lib2.bpmn_python.bpmn_diagram_import as bpmn_import
import bpmn_python_lib2.bpmn_python.bpmn_process_csv_import as bpmn_csv_import
import bpmn_python_lib2.bpmn_python.bpmn_process_csv_import as bpmn_csv_import
import bpmn_python_lib2.bpmn_python.bpmn_python_consts as consts
...
class BpmnDiagramGraph(object):
    ...
    * plane_attributes - dictionary that contains BPMN plane element attributes.
    ...
    def add_flow_node_to_diagram(self, process_id, node_type, name, pos_x, pos_y, node_id=None):
        ...
        self.diagram_graph.nodes[node_id][consts.Consts.width] = "200"
        self.diagram_graph.nodes[node_id][consts.Consts.height] = "200"
        self.diagram_graph.nodes[node_id][consts.Consts.x] = pos_x
        self.diagram_graph.nodes[node_id][consts.Consts.y] = pos_y
    ...
    def add_gateway_to_diagram(self, process_id, pos_x, pos_y, gateway_type, gateway_name="",
                               gateway_direction="Unspecified", node_id=None):
        """
        ...
        gateway_id, gateway = self.add_flow_node_to_diagram(process_id, gateway_type, gateway_name,
                                                            pos_x=pos_x, pos_y=pos_y, node_id=node_id)
    ...
    def add_parallel_gateway_to_diagram(self, process_id, pos_x, pos_y, gateway_name="", gateway_direction="Unspecified",
                                        node_id=None):
        """
        ...
        parallel_gateway_id, parallel_gateway = self.add_gateway_to_diagram(process_id,
                                                                            pos_x=pos_x,
                                                                            pos_y=pos_y,
                                                                            gateway_type=consts.Consts.parallel_gateway,
                                                                            gateway_name=gateway_name,
                                                                            gateway_direction=gateway_direction,
                                                                            node_id=node_id)
