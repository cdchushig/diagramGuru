...
class ShapeClassifier(object):
    """Shape Classifier, detects elements of handwritten flowchart using a pre-trained model and using Faster R-CNN like architecture.
	"""

    def __init__(self, results_path, bbox_threshold=0.5, overlap_thresh_1=0.5, overlap_thresh_2=0.3, use_gpu=False,
                 num_rois=0):
    ...
    def predict_and_save(self, image, image_name, folder_name):
        ...
        img, _ = self.__generate_final_image(bboxes, probs, image, roi_helper, ratio)
    ...
    def predict(self, image, display_image):
        """
        Object detection for flowchart and generate nodes for shapes and connectors.
        """
        image = Preprocessor.apply_unsharp_masking(image)
